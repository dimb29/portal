...
<?php endif; ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('search.nav-search', [])->html();
} elseif ($_instance->childHasBeenRendered('l1620331121-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1620331121-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1620331121-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1620331121-0');
} else {
    $response = \Livewire\Livewire::mount('search.nav-search', []);
    $html = $response->html();
    $_instance->logRenderedChild('l1620331121-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <!-- Teams Dropdown -->
                <?php if(Laravel\Jetstream\Jetstream::hasTeamFeatures() && Auth::user() != null): ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            <?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos() && Auth::user() != null): ?>
                                <span class="inline-flex rounded-md px-3">
                                    ...
                                    <button type="button" class="inline-flex items-center py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                            ...
                            <?php else: ?>
                                <span class="inline-flex px-1">
                                    <a href="<?php echo e(route('login')); ?>" class="px-1">Login</a>
                                    |
                                    <a href="<?php echo e(route('register')); ?>" class="px-1">Register</a>
                                </span>
                            <?php endif; ?>
                         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
            ...
            <div class="mt-3 space-y-1">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.responsive-nav-link','data' => ['href' => ''.e(route('login')).'','active' => request()->routeIs('login')]]); ?>
<?php $component->withName('jet-responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.responsive-nav-link','data' => ['href' => ''.e(route('register')).'','active' => request()->routeIs('register')]]); ?>
<?php $component->withName('jet-responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
